...
const PaperCard = ({
  ...
  return (
    <Card className="glass-morphism bg-primary-100 border border-primary-300 overflow-hidden hover:bg-primary-200 hover:shadow-lg transition-all duration-300">
      <div className="p-5">
